...
import type { MemberWithDetails } from '@/lib/repositories/contracts/loyalty'
import type { MemberPointsLog } from '@/types/database'
...
export default function MemberDetailPage() {
  ...
  const [member, setMember] = useState<MemberWithDetails | null | undefined>(undefined)
  const [log, setLog] = useState<MemberPointsLog[]>([])
